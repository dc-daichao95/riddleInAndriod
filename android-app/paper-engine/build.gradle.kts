...
val pinnedReplyAssets = mapOf(
    file("../../fonts/DancingScript.ttf") to "21808625578fe8d8cd10cb684be546dca077b27cd03a53a2f1ec11dc743c924c",
    file("../../fonts/OFL.txt") to "5a296979e49df4e947349fd6afdc3c0b305282d563f7ef2fad5412d2a235d1e8",
    file("../../fonts/LXGWWenKai-Regular.ttf") to "39ad71264b588165b469e35e6afb162a378dacd1f95348160240ba9038ac3009",
    file("../../fonts/LXGWWenKai-OFL.txt") to "c38b1994a5e48ac30ac7d1da7d0409fd8fd8127dfe28a13d6e787d5b1ef34a5e",
...
tasks.register<VerifySha256Task>("verifyPinnedReplyAssets") {
    ...
    assets.from(file("../../fonts/MANIFEST.sha256"), file("unicode-data/15.0.0/MANIFEST.sha256"))
    expectedHashes.set(pinnedReplyAssets.mapKeys { (asset, _) -> asset.absolutePath })
    manifests.put(file("../../fonts/MANIFEST.sha256").absolutePath, file("../../fonts").absolutePath)
...
androidComponents {
    onVariants { variant ->
        variant.sources.assets?.addStaticSourceDirectory("../../fonts")
    }
}
