...
- runs on Android 13 through Android 16 / API 33 through API 36 and compiles against the installed API 36.1 platform;
...
- Gradle Kotlin DSL;
- Android 13 through Android 16 runtime compatibility with `minSdk = 33` and `targetSdk = 36`;
